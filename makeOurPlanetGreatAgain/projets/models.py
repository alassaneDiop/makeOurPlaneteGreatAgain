...
class Evaluation(models.Model):
	...
	note_evaluation = models.PositiveIntegerField("Note du projet", default=0, validators=[MaxValueValidator(5)])
	date_evaluation = models.DateTimeField("Date d'évaluation", auto_now_add=True, blank=True)

class Like(models.Model):
    """docstring for Like"""
    like_authenticate_user = models.ForeignKey(User, default=1, on_delete=models.CASCADE)
